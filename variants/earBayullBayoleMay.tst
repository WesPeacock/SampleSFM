...
\lx arbay
\et Middle English: barre
\ps n
\de A solid, more or less rigid object of metal or wood with a uniform cross-section smaller than its length.
\xv eThay indowway asway rotectedpay ybay teelsay arsbay
\xe The window was protected by steel bars.

\lx arbay
\ps n
\de A business selling alcoholic drinks for consumption on the premises, or the premises themselves; a public house.

\lx arbay
\ps vt
\de To obstruct the passage of (someone or something).
\xv Ourway ayway asway arredbay ybay away ugehay ockfallray
\xe Our way was barred by a huge rockfall.

\lx illibarmay
\ps n
\de A non-SI unit of pressure equal to 100 pascals, used primarily to report atmospheric pressure.
\se arbay
\ps n
\de a thousand illibarmays

\lx arɓay
\lc arbay
\ps n
\de a common mispronunciation of arbay by speakers of languages where implosive stops are more frequent than ordinary stops.
